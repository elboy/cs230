...
arg_parser.add_argument("--years", type=int, default=2, help="average over past years years")
arg_parser.add_argument("--verbose", action="store_true")
args = arg_parser.parse_args()

if __name__ == '__main__':
    print("Downloading datasets from eval path: {}".format(os.path.join(os.getcwd(), args.data_dir, 'test.pkl')))
    #path_eval = os.path.join(os.getcwd(), args.data_dir, 'dev.pkl')
    path_eval = os.path.join(os.getcwd(), args.data_dir, 'test.pkl')
